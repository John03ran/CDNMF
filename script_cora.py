...
if __name__=='__main__':
    ...
    if os.path.exists(net_cache_file) and os.path.exists(att_cache_file):
        ...
        print("Warning: Cache files not found. You may need to run generate_pretrain_cache.py (modified for cora) or enable pre-training.")
    ...
    model_config = {
        ...
        "tau": 0.6157677441602935,
        "conc": 9.32420829246923,
        "negc": 2349,
        "rec": 0.9232766786747043,
        "r": 1.2920396112094885,
        "dropout": 0.30355312040933546,
        "learning_rate": 0.0023613522004179155,
        "weight_decay": 8.500539828837027e-06,
        'epoch': 1000,
        'run': 10,
    ...
    if not os.path.exists('./figures'):
        os.makedirs('./figures')
    plt.savefig('./figures/cora_training_all_runs.png')
    print("All runs curves saved to ./figures/cora_training_all_runs.png")
    ...
    plt.savefig('./figures/cora_training_mean.png')
    print("Mean curves saved to ./figures/cora_training_mean.png")
